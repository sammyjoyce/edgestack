...
export function ImageGallery({ onSelectImage, forField }: ImageGalleryProps) {
  const { images = [] } = useLoaderData<Route.LoaderData>();
                              ...
                              <div className="max-w-4xl mx-auto">
                                <div className="flex justify-between items-start mb-4">
                                  <div>
                                    ...
                                    <p className="text-sm text-gray-500">
                                      Uploaded {selectedImage && formatDate(selectedImage.uploadDate)}
                                    </p>
                                    <p className="text-sm text-gray-500">
                                  ...
                                  <div className="flex gap-2">
                                    {forField && (
                                      <fetcher.Form method="post" action="/admin/upload">
                                        <input type="hidden" name="intent" value="selectImage" />
                                        <input type="hidden" name="key" value={forField} />
                                        <input type="hidden" name="imageUrl" value={selectedImage?.url} />
