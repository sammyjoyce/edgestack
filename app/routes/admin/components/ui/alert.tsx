...
const icons = {
  ...
  warning: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
      <path fillRule="evenodd" d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0Zm-5.5-2.5a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0ZM10 12a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75v-.008a.75.75 0 0 0-.75-.75H10Z" clipRule="evenodd" />
    </svg>
  ),
  error: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="size-5">
...
const alertStyles = {
  ...
  variants: {
    info: {
      container: 'bg-blue-50 border-blue-300 dark:bg-blue-900/30 dark:border-blue-700',
      icon: 'text-blue-500 dark:text-blue-400',
      title: 'text-blue-800 dark:text-blue-200',
      description: 'text-blue-700 dark:text-blue-300',
    },
    success: {
      container: 'bg-green-50 border-green-300 dark:bg-green-900/30 dark:border-green-700',
      icon: 'text-green-500 dark:text-green-400',
      title: 'text-green-800 dark:text-green-200',
      description: 'text-green-700 dark:text-green-300',
    },
    warning: {
      container: 'bg-yellow-50 border-yellow-300 dark:bg-yellow-900/30 dark:border-yellow-700',
      icon: 'text-yellow-500 dark:text-yellow-400',
      title: 'text-yellow-800 dark:text-yellow-200',
      description: 'text-yellow-700 dark:text-yellow-300',
    },
    error: {
      container: 'bg-red-50 border-red-300 dark:bg-red-900/30 dark:border-red-700',
