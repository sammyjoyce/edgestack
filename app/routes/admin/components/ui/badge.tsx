...
const simplifiedColors = {
  neutral: 'bg-zinc-100 text-zinc-700 dark:bg-zinc-700 dark:text-zinc-200 group-data-hover:bg-zinc-200 dark:group-data-hover:bg-zinc-600',
  primary: 'bg-primary-100 text-primary-700 dark:bg-primary-700 dark:text-primary-200 group-data-hover:bg-primary-200 dark:group-data-hover:bg-primary-600',
  success: 'bg-green-100 text-green-700 dark:bg-green-700 dark:text-green-200 group-data-hover:bg-green-200 dark:group-data-hover:bg-green-600',
  warning: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-700 dark:text-yellow-200 group-data-hover:bg-yellow-200 dark:group-data-hover:bg-yellow-600',
  error: 'bg-red-100 text-red-700 dark:bg-red-700 dark:text-red-200 group-data-hover:bg-red-200 dark:group-data-hover:bg-red-600',
...
export const BadgeButton = forwardRef(function BadgeButton(
  ...
  return 'href' in props ? (
    <Link {...props} className={clsx(baseClasses, className)} ref={ref as React.ForwardedRef<HTMLAnchorElement>}>
      <TouchTarget>{badgeElement}</TouchTarget>
    </Link>
  ) : (
    <Headless.Button {...props} className={clsx(baseClasses, className)} ref={ref}>
      <TouchTarget>{badgeElement}</TouchTarget>
    </Headless.Button>
  )
})
