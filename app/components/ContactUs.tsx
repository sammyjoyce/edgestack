			...
			<div className="mx-auto max-w-6xl px-6 lg:px-8">
				<div className="mx-auto max-w-2xl">
					...
					<p className="mt-6 text-[15px] text-gray-300 leading-normal">
						From concept to completion, we're here to help bring your vision to
						life. Our expert team specializes in turning your ideas into
						stunning reality.
					</p>
					...
					<div className="mt-8 space-y-1 text-[11px] text-gray-400 leading-none">
						...
						<p className="font-medium">License Number: 4632530</p>
					</div>
