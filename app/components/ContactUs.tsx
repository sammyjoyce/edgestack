            ...
            <div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-white/5 lg:w-1/2">
              ...
              >
                <div
                  ...
                  className="aspect-1155/678 w-[72.1875rem] bg-gradient-to-br from-amber-500/20 to-amber-400/20 opacity-20"
                />
              </div>
            </div>
        ...
        >
          <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
            ...
            <div className="mt-8 flex justify-end">
              <button
                type="submit"
                className="rounded-md bg-amber-500 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-amber-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-500 transition-all"
              >
                Send message
              </button>
            </div>
