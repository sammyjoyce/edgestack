				...
				>
					<div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
						<div className="absolute inset-y-0 left-0 -z-10 w-full overflow-hidden ring-1 ring-gray-800 lg:w-1/2">
							...
							<div
								aria-hidden="true"
								className="absolute top-[calc(100%-13rem)] -left-20 transform-gpu blur-3xl lg:top-[calc(50%-7rem)] lg:-left-56"
							>
								<div
									style={{
										clipPath:
									...
									className="aspect-1155/678 w-[36rem] lg:w-[72.1875rem] bg-linear-to-br/oklch from-gray-800/20 to-gray-700/20 opacity-20"
								/>
							</div>
						</div>
						<h2 className="sr-only">Contact form</h2>
						<p className="mt-2 text-2xl sm:text-2xl md:text-3xl lg:text-4xl leading-tight tracking-[-1.43px] font-medium bg-linear-to-r/oklch from-white via-white/80 to-gray-300/50 sm:bg-linear-to-b/oklch md:bg-linear-to-r/oklch bg-clip-text text-transparent [text-wrap:balance]">
							Ready to Start Your Project?
						</p>
						<p className="mt-6 text-[15px] sm:text-[14px] leading-normal text-gray-300">
							From concept to completion, we're here to help bring your vision
							to life. Our expert team specializes in turning your ideas into
							stunning reality.
						</p>
						...
						<dl className="mt-10 space-y-4 text-[15px] sm:text-[14px] leading-normal text-gray-300">
							...
							<div className="flex gap-x-4">
								...
								<dd>
									<a
										href="tel:0404289437"
										className="hover:text-gray-100 transition-all duration-300 ease-in-out"
									>
										0404 289 437
									</a>
								</dd>
							...
							<div className="flex gap-x-4">
								...
								<dd>
									<a
										href="mailto:contact@lushconstructions.com"
										className="hover:text-gray-100 transition-all duration-300 ease-in-out"
									>
						...
						<div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
							...
							<div className="sm:col-span-2">
								<label
									...
									className="block text-[13px] leading-tight font-semibold text-gray-300"
								>
									Project Type
								</label>
