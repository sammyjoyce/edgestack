      ...
      <nav aria-label="Global" className="max-w-container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative flex items-center py-4">
          ...
          <a href="tel:0404289437" className="group -my-2 ml-6 hidden items-center gap-2 rounded bg-black/50 px-4 py-2 text-xs text-gray-300 ring-1 ring-gray-700 hover:bg-gray-800/50 hover:text-white hover:ring-gray-600 shadow-premium transition-all duration-300 sm:flex md:ml-8 lg:hidden min-[80rem]:flex">
            ...
            <span className="font-medium group-hover:text-gray-100 transition-colors duration-300">0404 289 437</span>
            <svg width="2" height="2" aria-hidden="true" className="fill-gray-500">
              <circle cx="1" cy="1" r="1" />
            </svg>
            <span className="font-medium">CALL NOW</span>
            <svg viewBox="0 0 5 8" className="h-2 w-[5px] fill-gray-500 group-hover:fill-gray-100 transition-colors duration-300" fillRule="evenodd" clipRule="evenodd" aria-hidden="true">
          ...
          >
            ...
            <svg viewBox="0 0 24 24" className="size-6 stroke-gray-300 hover:stroke-gray-100 transition-colors duration-200">
