            ...
            <li key={person.name} className="flex flex-col gap-10 sm:flex-row">
              ...
              <div className="max-w-xl flex-auto">
                ...
                <ul role="list" className="mt-6 flex gap-x-6">
                  <li>
                    <a href={person.instagramUrl} className="text-gray-400 hover:text-gray-100 rounded-full p-1 hover:bg-gray-900/50 hover:inset-shadow-sm hover:inset-shadow-white/5 transition-all duration-300 ease-in-out">
