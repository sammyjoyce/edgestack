	...
	return (
		<div className="relative py-24 md:py-32 overflow-hidden" id="about">
			...
			<div className="absolute inset-y-0 right-0 -z-10 w-[200%] overflow-hidden lg:w-[100%] xl:-mr-96">
				<svg
					className="absolute h-full w-full stroke-gray-800 [mask-image:radial-gradient(100%_100%_at_top_left,white,transparent)]"
					aria-hidden="true"
				>
					<defs>
						<pattern
								...
								<ul className="mt-6 flex gap-x-6">
									<li>
										<a
											...
											className="text-gray-400 hover:text-gray-100 rounded-full p-1 hover:bg-gray-900/50 hover:inset-shadow-sm hover:inset-shadow-white/5 transition-all duration-300 ease-in-out"
										>
