...
CREATE TABLE `__new_content` (
	...
	`metadata` text,
	`updated_at` integer DEFAULT '"2025-04-29T13:43:54.795Z"',
...
CREATE TABLE `__new_media` (
	...
	`width` integer,
	`height` integer,
	`created_at` integer DEFAULT '"2025-04-29T13:43:54.796Z"'
);
--> statement-breakpoint
...
CREATE TABLE `__new_projects` (
	...
	`sort_order` integer DEFAULT 0,
	`created_at` integer DEFAULT '"2025-04-29T13:43:54.796Z"',
	`updated_at` integer DEFAULT '"2025-04-29T13:43:54.796Z"'
);
--> statement-breakpoint
